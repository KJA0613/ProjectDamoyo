...
public interface ICompanyDAO {
	...
	public boolean companyRegist(CompanyDTO cdto) throws SQLException;
	...
	// [기업회원] 비번찾기
	public CompanyDTO comfindPW(String comId) throws SQLException;

	// [기업회원] 회원정보수정
	public boolean updatecomInfo(CompanyDTO cdto) throws SQLException;
	
	// [기업회원] 회원비밀번호수정
	public boolean CompanyPwModify(CompanyDTO cdto) throws SQLException;
