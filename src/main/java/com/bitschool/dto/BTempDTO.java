...
public class BTempDTO {
	...
	public String getGatherCategoryMid() {
		return gatherCategoryMid;
	}
	public void setGatherCategoryMid(String gatherCategoryMid) {
		this.gatherCategoryMid = gatherCategoryMid;
	}
