...
<nav class="navbar navbar-transparent navbar-fixed-top navbar-color-on-scroll" >
  <div class="container">
    ...
    <div class="navbar-header">
      ...
      <a href="http://www.creative-tim.com">
           <div class="logo-container">
                <div class="logo">
                    <img src="/resources/admin/img/new_logo.png" alt="Creative Tim Logo">
                </div>
                <div class="brand">
                    DAMOYO 관리자
                </div>
	...
	<div class="page-header header-filter" style="background-image: url('/resources/admin/img/cover.jpeg');">
		<div class="container">
			<div class="row">
	                ...
	                <nav class="navbar navbar-default" role="navigation">
	                	<div class="container-fluid">
	                    	<div class="navbar-header">
	                    		...
	                    		<a class="navbar-brand" href="#pablo">DAMOYO 관리자 페이지</a>
	                    	</div>
