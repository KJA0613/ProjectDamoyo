...
<body>
	...
	<div class="wrapper">
		<div class="sidebar" data-color="blue"
			data-image="/resources/admin/img/sidebar-1.jpg">
			<!--
			...
			<div class="logo">
				<a href="" class="simple-text"> DAMOYO 관리자 </a>
			</div>


			<div class="sidebar-wrapper">
				<ul class="nav">
					<li class="active"><a href="/dashbord"> <i
							class="material-icons">dashboard</i>
							<p>Dashboard</p>
					</a></li>
					<li><a href="/PeopleTable"> <i class="material-icons">person</i>
							<p>회원관리</p>
					</a></li>
					<li><a href="/"> <i class="material-icons">content_paste</i>
							<p>게시판관리</p>
					</a></li>
					<li><a href="/category"> <i class="material-icons">library_books</i>
							<p>카테고리관리</p>
					</a></li>
					<li><a href="icons.jsp"> <i class="material-icons">bubble_chart</i>
							<p>통계보기</p>
					</a></li>
					<li><a href="maps.jsp"> <i class="material-icons">location_on</i>
							<p>지도</p>
					</a></li>
