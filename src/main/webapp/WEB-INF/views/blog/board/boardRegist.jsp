...
<body>
	...
	<div id="wrapper" class="toggled">
		...
		<div class="container" style="margin-left: 20px;">
			<h4 style="margin-top: 50px; margin-left: 50px;">자유게시판 글쓰기</h4>
			<form action="/blog/board/boardRegist?blogId=${blogId}&blogName=${blogName}" method="POST" style="width:600px; margin-top: 20px;">
