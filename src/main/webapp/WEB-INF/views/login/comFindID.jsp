...
<script type="text/javascript">
	...
	$(document).ready(function() {
		$('#btnfindID').click(function() {
			...
			document.findIdForm.action = "/member/LoginForm";
		});
	});
</script>
			...
			<div class="col-md-8 col-md-offset-2">
				...
				<form action="" method="POST" id="dataset" name="findIdForm">
					...
					<div class="form-group">
						...
						<input type="text" id="input_guserName" name="guserName"
							class="form-control" placeholder="이름을 입력하세요." tabindex="1">
					</div>
					<div class="form-group">
					...
					<div class="form-group pull-right">
						...
						<!-- 메인페이지로 이동 -->
						<button type="submit" class="btn btn-primary" id="btnfindID"
